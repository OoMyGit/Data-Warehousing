CREATE DATABASE IF NOT EXISTS oltp_steivan;
USE oltp_steivan;
...
BEGIN
  ...
  SET new_id = CONCAT('UB', LPAD(max_id, 5, '0'));
...
BEGIN
  ...
  SET new_id = CONCAT('TB', LPAD(max_id, 5, '0'));
...
BEGIN
  ...
  SET new_id = CONCAT('PB', LPAD(max_id, 5, '0'));
...
('PB00001', 'UB00001', '2024-06-01', 29000000),
('PB00002', 'UB00002', '2024-06-02', 400000),
('PB00003', 'UB00003', '2024-06-03', 2500000),
('PB00004', 'UB00004', '2024-06-04', 1500000),
('PB00005', 'UB00005', '2024-06-05', 4500000),
('PB00006', 'UB00006', '2024-06-06', 1800000),
('PB00010', 'UB00007', '2024-06-07', 7200000),
('PB00005', 'UB00008', '2024-06-08', 3000000),
('PB00008', 'UB00009', '2024-06-09', 1500000),
('PB00013', 'UB00010', '2024-06-10', 7500000),
('PB00014', 'UB00011', '2024-06-11', 4500000),
('PB00021', 'UB00012', '2024-06-12', 2400000),
('PB00025', 'UB00013', '2024-06-13', 6000000),
('PB00020', 'UB00014', '2024-06-14', 8000000),
('PB00010', 'UB00015', '2024-06-15', 2700000),
('PB00007', 'UB00016', '2024-06-16', 1800000),
('PB00009', 'UB00017', '2024-06-17', 900000),
('PB00007', 'UB00018', '2024-06-18', 1750000),
('PB00006', 'UB00019', '2024-06-19', 3000000),
('PB00001', 'UB00020', '2024-06-20', 14500000),
('PB00002', 'UB00021', '2024-06-21', 7200000),
('PB00008', 'UB00022', '2024-06-22', 3000000),
('PB00009', 'UB00023', '2024-06-23', 1200000),
('PB00010', 'UB00024', '2024-06-24', 8000000),
('PB00002', 'UB00025', '2024-06-25', 1500000);
