CREATE DATABASE IF NOT EXISTS oltp_juan;
USE oltp_juan;
...
BEGIN
  ...
  SET new_id = CONCAT('UC', LPAD(max_id, 5, '0'));
...
BEGIN
  ...
  SET new_id = CONCAT('TC', LPAD(max_id, 5, '0'));
...
BEGIN
  ...
  SET new_id = CONCAT('PC', LPAD(max_id, 5, '0'));
...
('PC00001', 'UC00001', '2024-06-01', 29000000),
('PC00002', 'UC00002', '2024-06-02', 400000),
('PC00003', 'UC00003', '2024-06-03', 2500000),
('PC00004', 'UC00004', '2024-06-04', 1500000),
('PC00005', 'UC00005', '2024-06-05', 4500000),
('PC00006', 'UC00006', '2024-06-06', 1800000),
('PC00010', 'UC00007', '2024-06-07', 7200000),
('PC00005', 'UC00008', '2024-06-08', 3000000),
('PC00008', 'UC00009', '2024-06-09', 1500000),
('PC00013', 'UC00010', '2024-06-10', 7500000),
('PC00014', 'UC00011', '2024-06-11', 4500000),
('PC00021', 'UC00012', '2024-06-12', 2400000),
('PC00025', 'UC00013', '2024-06-13', 6000000),
('PC00020', 'UC00014', '2024-06-14', 8000000),
('PC00010', 'UC00015', '2024-06-15', 2700000),
('PC00007', 'UC00016', '2024-06-16', 1800000),
('PC00009', 'UC00017', '2024-06-17', 900000),
('PC00007', 'UC00018', '2024-06-18', 1750000),
('PC00006', 'UC00019', '2024-06-19', 3000000),
('PC00001', 'UC00020', '2024-06-20', 14500000),
('PC00002', 'UC00021', '2024-06-21', 7200000),
('PC00008', 'UC00022', '2024-06-22', 3000000),
('PC00009', 'UC00023', '2024-06-23', 1200000),
('PC00010', 'UC00024', '2024-06-24', 8000000),
('PC00002', 'UC00025', '2024-06-25', 1500000);
